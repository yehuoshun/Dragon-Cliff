...
{
	// Token: 0x060001E9 RID: 489 RVA: 0x0002D510 File Offset: 0x0002B910
	public _2dxFX_AL_Slim()
	{
	}

	// Token: 0x060001EA RID: 490 RVA: 0x0002D57E File Offset: 0x0002B97E
	private void Awake()
	{
	...
	// Token: 0x060001EB RID: 491 RVA: 0x0002D5A8 File Offset: 0x0002B9A8
	private void Start()
	{
	...
	// Token: 0x060001EC RID: 492 RVA: 0x0002D638 File Offset: 0x0002BA38
	public void CallUpdate()
	{
		this.Update();
	}

	// Token: 0x060001ED RID: 493 RVA: 0x0002D640 File Offset: 0x0002BA40
	private void Update()
	{
		...
		if (this.ActiveChange)
		{
			if (base.gameObject.GetComponent<SpriteRenderer>() != null)
			{
				...
				base.GetComponent<Renderer>().sharedMaterial.SetFloat("_Distortion", this.SlimDistortion);
				...
				base.GetComponent<Renderer>().sharedMaterial.SetFloat("TurnToLiquid", this.TurnToSlim);
			}
			else if (base.gameObject.GetComponent<Image>() != null)
			{
	...
	// Token: 0x060001EE RID: 494 RVA: 0x0002DD24 File Offset: 0x0002C124
	...
	// Token: 0x060001EF RID: 495 RVA: 0x0002DE30 File Offset: 0x0002C230
	...
	// Token: 0x060001F0 RID: 496 RVA: 0x0002DF0C File Offset: 0x0002C30C
